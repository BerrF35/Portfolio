...
export class PixelGameEngine {
  constructor(container) {
    ...
    // Viewport dimensions (High-DPI 2x internal resolution for crisp readable rendering)
    this.vw = 640;
    this.vh = 400;
    ...
    this.stations = [
      ...
      },
      {
        ...
        badge: 'UNDERGRADUATE',
        copy: 'B.Tech Information Technology, Vellore Institute of Technology (VIT), Vellore (2025-2029, current 1st year). Building at the boundary of software, AI, and physical hardware.',
      },
      {
        id: 'dog_berry',
        name: 'BERRY (PET DOG)',
        ...
        title: 'BERRY // PET DOG',
        badge: 'PET DOG',
        copy: 'Berry the pet Belgian Malinois dog.',
      },
      {
        id: 'cat_crispy',
        name: 'CRISPY (PET CAT)',
