...
export const HARDWARE_DEFINITIONS = {
  ...
  cat: {
    ...
    title: 'CRISPY // 10-YEAR-OLD COMPANION CAT',
    eyebrow: 'WORKBENCH COMPANION // CRISPY',
    category: 'LAB COMPANION',
    summary: 'Crispy is Jaijitesh\'s 10-year-old companion cat, faithfully supervising hardware development, firmware flashing, and late-night research sessions on the workbench.',
    specs: [
      ['NAME', 'Crispy'],
      ['AGE', '10 Years Old'],
      ['SPECIES', 'Domestic Feline'],
      ['STATUS', 'Chief Workbench Supervisor & Morale Officer'],
    ],
    scale: 0.72,
    isGroundedOnFloor: false,
  ...
  dog: {
    ...
    title: 'BERRY // 12-YEAR-OLD BELGIAN MALINOIS',
    eyebrow: 'LAB COMPANION & INSPIRATION // BERRY',
    category: 'LAB COMPANION & ROBOT NAMESAKE',
    summary: 'Berry is Jaijitesh\'s beloved 12-year-old Belgian Malinois dog. The namesake and spirit behind both the Berry Desktop AI Assistant and the BerryBot Tracked Autonomous Robotics platform.',
    specs: [
      ['NAME', 'Berry'],
      ['BREED', 'Belgian Malinois (Shepherd)'],
      ['AGE', '12 Years Old'],
      ['LEGACY', 'Namesake of Berry AI Agent & BerryBot Robotics'],
      ['ROLE', 'Loyal Lab Companion & Security Chief'],
    ],
    scale: 0.92,
    isGroundedOnFloor: true,
    benchPosition: new THREE.Vector3(-1.62, 0, 1.05), // Fully visible in front of desk with zero ear clipping
    benchRotation: new THREE.Euler(0, 0.45, 0),
  },
  telescope: {
    id: 'telescope',
